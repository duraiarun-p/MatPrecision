...
% Registration Method
    ...
    [CX,MADUR,~,~,DSC2B,DSC1B,MADB,TimeB]=BLMIR(directory_name1,directory_name2,3);
%     [CX1,MADUR1,~,~,DSC2B1,DSC1B1,MADB1,TimeB1]=BLMIR(directory_name1,directory_name2,5);
%     [CX2,MADUR2,~,~,DSC2B2,DSC1B2,MADB2,TimeB2]=BLMIR(directory_name1,directory_name2,7);
   
    [DiceC,DiceCn,MADC,TimeC]=plastibspline(directory_name1,directory_name2,plastiworkpath,PlanScanName,TretScanName);
    [DiceD,DiceDn,MADD,TimeD]=plastidemons(directory_name1,directory_name2,plastiworkpath,PlanScanName,TretScanName);
    
    filecount=filecount+1;
    
    T{filecount,2}=[DiceA,DSC2B,DiceC,DiceD,DiceAn,DSC1B,DiceCn,DiceDn,TimeA,TimeB,TimeC,TimeD,MADA,MADB,MADC,MADD,MADUR,CX];
    T{filecount,1}=TretScanName;
    cd /home/arun/Documents/MATLAB/ImageOutputs/PerfComp/run4;
...
%% Wrapper BLMIR 3D
function [Cr,MADUR,Rel2,Rel1,DSC2,DSC1,MAD1,NMAD1,time]=BLMIR(directory_name1,directory_name2,indSize)
...
[Cr,MADUR,Rel2,Rel1,DSC2,DSC1,MAD1,time]=BLMIR3DDiceFx_24_inbuilt(Z1a,IP1a,IT1a,MP2a,MT2a,indSize,mbSize,p,lambda1A,lambda3,m,n,LenX,LenY,costV);%1 lambda
end

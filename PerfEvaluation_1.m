...
%%    
    ...
    T{filecount,2}=[DiceA,DSC2B,DiceC,DiceAn,DSC1B,DiceCn,MADA,MADB,MADC,TimeA,TimeB,TimeC];
    T{filecount,1}=TretScanName;
    cd /home/arun/Documents/MATLAB/ImageOutputs/PerfComp/run2;
...
function [DiceMatlab,DicePlasti,MAD1,comptime]=plastibspline(directory_name1,directory_name2,plastiworkpath,PlanScanName,TretScanName)

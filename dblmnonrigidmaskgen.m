function [ITE,MTE]=dblmnonrigidmaskgen(PlanCTR,PreCBCTData,PreCBCTLoca,PlanMask1)
...
% lambda1A=0;% Distance Regularisation
% lambda3=0;
...
%     mV2=BL3DSecndPass_stripped_2_inbuilt(imgTreatment,imgPlanning,mV1,mbSize,p,ZLocV,indz,indL,lambda1A,lambda3,m,n,LenX,LenY,costV); % 2nd Pass
    ...
    mV1=BL3DFirstPass_stripped_3_inbuilt(IT1(:,:,ind),IP11(:,:,indz),mbSize,p,ZLocV,indz,indL,lambda1A,m,n,costV); % 1st Pass
    mV2=BL3DSecndPass_stripped_2_inbuilt(IT1(:,:,ind),IP11(:,:,indz),mV1,mbSize,p,ZLocV,indz,indL,lambda1A,lambda3,m,n,LenX,LenY,costV); % 2nd Pass    
...
function Bl1=omegdiif_DrDave(r,M,N)

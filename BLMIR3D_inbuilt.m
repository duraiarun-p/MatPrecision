...
% directory_name2a='/home/arun/Documents/MATLAB/ImageDB/Bladder/blar2/B777394';
directory_name1a='/home/arun/Documents/MATLAB/ImageDB/Bladder/blar1/0428705';
directory_name2a='/home/arun/Documents/MATLAB/ImageDB/Bladder/blar1/D428705';
...
%%
% directory_name1b='/home/s1785969/RDS/MATLAB/ImageDB/Bladder/blar9/0780334';
% directory_name2b='/home/s1785969/RDS/MATLAB/ImageDB/Bladder/blar4/D789355';
% [Crb,R2b,R1b,DSC2b,DSC1b]=BLMIR(directory_name1b,directory_name2b,1);
% %%
% directory_name1c='/home/s1785969/RDS/MATLAB/ImageDB/Bladder/blar9/0780334';
% directory_name2c='/home/s1785969/RDS/MATLAB/ImageDB/Bladder/blar6/A688080';
...
function [Cr,Rel2,Rel1,DSC2,DSC1]=BLMIR(directory_name1,directory_name2)
...
% lambda3=0.005;
lambda1A=0.15;% Distance Regularisation
lambda3=0.0145;
costV=2^16+1;
...
[Cr,Rel2,Rel1,DSC2,DSC1]=BLMIR3DDiceFx_24_inbuilt(Z1a,IP1a,IT1a,MP2a,MT2a,indSize,mbSize,p,lambda1A,lambda3,m,n,LenX,LenY,costV);%1 lambda
end
%%
...
function [Cr,ECV1,ECV,DSC2,DSC1]=BLMIR3DDiceFx_24_inbuilt(Z1,IP1,IT1,MP2,MT2,indSize,mbSize,p,lambda1A,lambda3,m,n,LenX,LenY,costV)
...
%     for ind=58:58
    ...
    MTE1=dustthemask(MTE1,m,n);% Mask Correction
    MTE2=dustthemask(MTE2,m,n);
    ITE1=motioncomp3d_1_inbuilt(imgPlanning,mV2,m,n,indL,mbSize);
    E(ind,1)=sum(mV1(:,7));
    E1(ind,1)=sum(mV2(:,7));
...
%                 dist(m1+p+1,n1+p+1,zi) = (round(norm([i j]-[refBlkVer refBlkHor])+abs(ZLocV(zi))));

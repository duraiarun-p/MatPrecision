...
matfilename=[patfolder(folderi).name,'-','DB'];


save(matfilename,'PlanCTPath','PlanCTInfo','PlanCTLoca','PreCBCTInfo','PreCBCTPath',...
    'PreCBCTLoca','PosCBCTInfo','PosCBCTPath','PosCBCTLoca');
